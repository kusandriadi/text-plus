...
<style>
  ...
  .preview.dark { background: #1e1e1e; border-color: #3c3c3c; color: #d4d4d4; }
  ...
  .preview.dark :global(th), .preview.dark :global(td) { border-color: #3c3c3c; }
  .preview :global(th) { background: #f4f4f4; font-weight: 600; }
  .preview.dark :global(th) { background: #2d2d2d; }
  .preview :global(hr) { border: none; border-top: 1px solid #ddd; margin: 16px 0; }
  .preview.dark :global(hr) { border-color: #3c3c3c; }
